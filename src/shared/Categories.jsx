        ...
        <div className="mt-10 mb-10 mx-5">
            ...
            <div className="grid grid-cols-3 gap-3 lg:w-2/3 mx-auto mb-10">
                <button onClick={() => { setSearchCategory('workshop') }}>
                    <div  className={`bg-white ${searchCategory === 'workshop' ? 'bg-[#f17092] text-white ' : ''} flex tablet:flex-row flex-col lg:flex-row  mobile-s:gap-1 gap-3 items-center text-center justify-center py-3 rounded-lg`}>
                ...
                <button onClick={() => { setSearchCategory('webinar') }}>
                    <div className={`bg-white ${searchCategory === 'webinar' ? 'bg-[#f17092] text-white' : ''} flex tablet:flex-row flex-col lg:flex-row  mobile-s:gap-1 gap-3 items-center text-center justify-center py-3 rounded-lg`}>
                ...
                <button onClick={() => { setSearchCategory('career fair') }}>
                    <div className={`bg-white ${searchCategory === 'career fair' ? 'bg-[#f17092]  text-white' : ''} flex tablet:flex-row flex-col lg:flex-row  mobile-s:gap-1 gap-3 items-center text-center justify-center py-3 rounded-lg`}>
                ...
                <button onClick={() => { setSearchCategory('conference') }}>
                    <div className={`bg-white ${searchCategory === 'conference' ? 'bg-[#f17092] text-white '  : ''} flex tablet:flex-row flex-col lg:flex-row  mobile-s:gap-1 gap-3 items-center text-center justify-center py-3 rounded-lg`}>
                ...
                <button onClick={() => { setSearchCategory('seminar') }}>
                    <div className={`bg-white ${searchCategory === 'seminar' ? 'bg-[#f17092] text-white ' : ''} flex tablet:flex-row flex-col lg:flex-row  mobile-s:gap-1 gap-3 items-center text-center justify-center py-3 rounded-lg`}>
                ...
                <button onClick={() => { setSearchCategory('') }}>
                    <div className={`bg-white ${searchCategory === '' ? 'bg-[#f17092] text-white ' : ''} flex tablet:flex-row flex-col lg:flex-row  mobile-s:gap-1 gap-3 items-center text-center justify-center py-3 rounded-lg`}>
                        <GoStack></GoStack>
